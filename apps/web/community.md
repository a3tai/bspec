...
- [Core Concepts](/docs/concepts) - Understand the fundamentals
- [Full Specification](/spec/v1-0-0) - Read the complete technical spec

### Tools
- [CLI Tool](/docs/tools/cli) - Command-line interface for BSpec
- [TypeScript SDK](/docs/tools/typescript) - TypeScript library
- [Python SDK](/docs/tools/python) - Python library
- [Go SDK](/docs/tools/go) - Go library
- [MCP Server](/docs/tools/mcp) - AI integration server
